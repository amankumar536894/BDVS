(function ($) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        // Select the element with the tooltip
        const tooltipElement = document.querySelector('[data-tooltip]');

        // Function to toggle the tooltip visibility
        function toggleTooltip() {
            tooltipElement.classList.toggle('show-tooltip');
        }

        // Start the interval to toggle the tooltip every 5 seconds
        setInterval(toggleTooltip, 5000);

        // Initial delay before first showing the tooltip
        setTimeout(toggleTooltip, 5000);
    });
    s
